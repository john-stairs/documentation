...
!!! warning
    This version introduces a completely new architecture and therefore major breaking changes! It is essentially a new asset which is much easier to use, maintain and extend. It is recommended to stay at your current version if you do not want to benefit from the new architecture. Always keep a version control or backup in place to be able to roll back your project to an earlier version in case of issues due to incompatibilities!

- New software architecture to make maintainability and extensibility much easier
- I tried to reach feature parity with the previous version but there might be small, very special features which I have forgotten among the numerous other features. [Reach out to me](mailto:mail@johnstairs.com) if you are missing anything
